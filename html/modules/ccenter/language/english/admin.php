...
define('_AM_FORM_DEFS', 'Form definitions');
define('_AM_FORM_DEFS_DESC', '<a href="help.php#form" target="_blank">Definitions</a> <small>Types: text checkbox radio textarea select const hidden mail file</small>');
