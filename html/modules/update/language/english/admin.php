...
define('_AM_REG_DESCRIPTION', 'Select which packages you want follow updates, and submit "'._AM_REG_SUBMIT.'" button. Uncheck packages to remove register. There is no checkbox for packages without information.');

define('_AM_AUTH_REGISTER', 'Register Update Server Authorization');
...
define('_AM_AUTH_SESSION_NONE', 'There is No Authorization');
define('_AM_AUTH_SESSION_OK', 'Authorization Normal (No need setting)');
define('_AM_AUTH_SESSION_NG', 'Authorization Failer');
