...
if (MYXBU_DEBUG) {
	xoops_cp_header();
	print '<div class="adminnavi">BACKUP &raquo;&raquo; Debug Mode</div>
	<br />';
	print '<div class="confirmMsg">DEBUG MODE</div>
	<br />
	<div class="outer" style="display:block; width:600px; height:300px; overflow:auto; border:1px solid #ccc;"';
