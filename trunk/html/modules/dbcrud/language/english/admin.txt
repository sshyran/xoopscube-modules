...
$admin_consts = array(
    ...
    '_VALUE_RANGE_DESC'     => '「値型」が「整数」か「小数」の場合のみ有効',
    '_DEFAULT'              => '初期値',
    '_SIZE'                 => '初期入力サイズ',
    '_MSELECT_SIZE'         => '表示行数',
    '_MAX_LENGTH'           => '最大入力サイズ',
    '_AMBIGUOUS'            => 'あいまい検索',
    '_AMBIGUOUS_DESC'       => '「値型」が「文字列」の場合のみ有効',
    '_FOR_SEARCH'           => '(検索ページ)',
    '_ENABLE'               => '有効',
    '_DISABLE'              => '無効',
    '_OPTIONS'              => '選択肢',
    ...
    '_NOTE_ALLOWED_EXTS'    => '<br /><b>[入力例]</b> <br />pdf<br />xls<br />doc',
    '_NOTE_ALLOWED_MIMES'   => '<br /><b>[入力例]</b> <br />application/pdf<br />application/x-pdf',
    ...
    '_LINK_ERR_MSG'         => '非必須項目、一覧非表示項目は、一覧リンクに設定できません。',
    '_REQ_LINK_ERR_MSG'     => '一覧リンクが「はい」の項目は、非必須にできません。',
    '_LIST_LINK_ERR_MSG'    => '一覧リンクが「はい」の項目は、一覧で非表示にできません。',
    '_DELETE_LINK_ERR_MSG'  => '一覧リンクが「はい」の項目がなくなるため、この項目を削除できません。',
    '_UPDATE_LINK_ERR_MSG'  => '一覧リンクが「はい」の項目がなくなるため、一覧リンクを「いいえ」に変更できません。',
