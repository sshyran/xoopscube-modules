...
define ("_AM_MYXBACKUP_DBCHECKERROR",	"Error ! (Database might be changed)");
define ("_AM_MYXBACKUP_FILECHECKERROR",	"Error ! (SQL files might be changed)");
define ("_AM_MYXBACKUP_RESTOREERROR",	"<div style=\"color:#ff0000; font-size:larger; margin-left:20px;\">Error ! (SQL files might be changed)</div>");
...
//	Clean Up
define ("_AM_MYXBACKUP_CAUTIONTODEL",		"<span style=\"color:#ff0000;\">Necessary tables might be listed up in the case of DUPLICATABLE modules.<br />DO NOT DELETE any tables if you are not confident.<br />You should BACK-UP before this operation.</span>");
