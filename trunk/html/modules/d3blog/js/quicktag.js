...
function edToolbar() {
    ...
    if (edShowExtraCookie()) {
        document.write(
            '<input type="button" id="entityRef" class="ed_button" onclick="entityReferencing();" value="Entity" />'
...
function entityReferencing(){
    ...
    if (d.selection) {
      ...
      // Firefox, Opera
      var ta = d.getElementsByTagName('textarea'); // get extarea
      for (var i = 0; i < ta.length; i++) {
        // if contents exists inteatarea
        if (ta[i].value) {
