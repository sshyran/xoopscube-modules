 ...
 */
class Sabai_Model_Criteria_EndsWith extends Sabai_Model_Criteria_String
{
    function Sabai_Model_Criteria_EndsWith($key, $str)
    {
        parent::Sabai_Model_CriteriaString($key, $str);
