...
<h3><?php printf(_('Adding %s'), $entity_name);?></h3>
...
<?php endif;?>
<?php $this->HTML->formTag('post', array('base' => '/role/add'));?>
  <table class="vertical">
    ...
    <tfoot>
      <tr>
        <td colspan="2"><input type="submit" value="<?php echo _('Create');?>" class="button" /></td>
      </tr>
    </tfoot>
    <tbody>
