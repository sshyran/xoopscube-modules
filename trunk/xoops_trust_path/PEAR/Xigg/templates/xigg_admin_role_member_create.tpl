...
<?php endif;?>
<?php $this->HTML->formTag('post', array('base' => '/role/' . $role_id . '/member/add'));?>
  <table class="vertical">
    ...
    <tfoot>
      <tr>
        <td colspan="2"><input type="submit" value="<?php echo _('Add');?>" class="button" /></td>
      </tr>
    </tfoot>
    <tbody>
