...
define($constpref.'_ICON_MEANINGSDSC','Укажите альтернативное значение иконок. Каждое значение должно быть разделено символом (|). Первое значение соответствует файлу "posticon0.png".');
