...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return coupons_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'coupons_onuninstall_base' ) ) {

  function coupons_onuninstall_base( $module , $mydirname )
  {
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUninstall.' . ucfirst($mydirname) . '.Success' , 'coupons_message_append_onuninstall' ) ;
		$ret = array() ;
	} else {
  ...
  function coupons_message_append_onuninstall( &$module_obj , &$log )
  {
