...
if(! class_exists('d3imgtagTextSanitizer')) {

include_once(XOOPS_ROOT_PATH . '/class/module.textsanitizer.php');

class d3imgtagTextSanitizer extends MyTextSanitizer {
	...
	*/
	function d3imgtagTextSanitizer()
	{
	...
	function &getInstance()
	{
		static $instance;
		if (!isset($instance)) {
			$instance = new d3imgtagTextSanitizer();
		}
		return $instance;
	}
...
/*		if ($html != 1) {
	...
	*/
	function stripSlashesGPC($text)
	{
		...
		if(function_exists('d3imgtag_callback_after_stripslashes_local')) {
			$text = d3imgtag_callback_after_stripslashes_local($text);
		}
