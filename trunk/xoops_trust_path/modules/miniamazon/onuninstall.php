...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return miniamazon_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'miniamazon_onuninstall_base' ) ) {

function miniamazon_onuninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUninstall.' . ucfirst($mydirname) . '.Success' , 'miniamazon_message_append_onuninstall' ) ;
		$ret = array() ;
	} else {
...
function miniamazon_message_append_onuninstall( &$module_obj , &$log )
{
