...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return miniamazon_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'miniamazon_oninstall_base' ) ) {

function miniamazon_oninstall_base( $module , $mydirname )
{
	global $ret ; // TODO :-D 
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'miniamazon_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function miniamazon_message_append_oninstall( &$module_obj , &$log )
{
