...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return flatdata_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;



if( ! function_exists( 'flatdata_oninstall_base' ) ) {

function flatdata_oninstall_base( $module , $mydirname )
{
	global $ret ; // TODO :-D 
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'flatdata_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function flatdata_message_append_oninstall( &$module_obj , &$log )
{
