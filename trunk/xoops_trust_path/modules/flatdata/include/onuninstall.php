...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return flatdata_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'flatdata_onuninstall_base' ) ) {

  function flatdata_onuninstall_base( $module , $mydirname )
  {
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUninstall.' . ucfirst($mydirname) . '.Success' , 'flatdata_message_append_onuninstall' ) ;
		$ret = array() ;
	} else {
  ...
  function flatdata_message_append_onuninstall( &$module_obj , &$log )
  {
