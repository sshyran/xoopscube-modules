...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return treemenu_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'treemenu_oninstall_base' ) ) {

function treemenu_oninstall_base( $module , $mydirname )
{
	global $ret ; // TODO :-D 
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'treemenu_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function treemenu_message_append_oninstall( &$module_obj , &$log )
{
