...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return myxcmodule_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'myxcmodule_oninstall_base' ) ) {

function myxcmodule_oninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'myxcmodule_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function myxcmodule_message_append_oninstall( &$module_obj , &$log )
{
