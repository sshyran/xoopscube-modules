...
eval( ' function xoops_module_uninstall_'.$mydirname.'( $module ) { return myxcmodule_onuninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'myxcmodule_onuninstall_base' ) ) {

function myxcmodule_onuninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUninstall.' . ucfirst($mydirname) . '.Success' , 'myxcmodule_message_append_onuninstall' ) ;
		$ret = array() ;
	} else {
...
function myxcmodule_message_append_onuninstall( &$module_obj , &$log )
{
