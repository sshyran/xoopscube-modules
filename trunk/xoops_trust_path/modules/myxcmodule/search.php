...
{
	return myxcmodule_global_search_base( "'.$mydirname.'" , $keywords , $andor , $limit , $offset , $userid ) ;
}

' ) ;


if( ! function_exists( 'myxcmodule_global_search_base' ) ) {

function myxcmodule_global_search_base( $mydirname , $keywords , $andor , $limit , $offset , $userid )
{
