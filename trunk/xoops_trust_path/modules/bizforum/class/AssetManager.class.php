...
/**
 * Bizforum_AssetManager
**/
class Bizforum_AssetManager
{
    /**
     * @brief   string
    **/
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Bizforum_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Bizforum_AssetManager[]
        **/
        static $instance = array();
    
        if(!isset($instance[$dirname]))
        {
            $instance[$dirname] = new Bizforum_AssetManager($dirname);
        }
    ...
    **/
    ...
    {
        return BIZFORUM_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}
