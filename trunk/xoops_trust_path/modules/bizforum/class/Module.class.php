...
require_once BIZFORUM_TRUST_PATH . '/class/AbstractAction.class.php';

define('BIZFORUM_FRAME_PERFORM_SUCCESS', 1);
define('BIZFORUM_FRAME_PERFORM_FAIL', 2);
define('BIZFORUM_FRAME_INIT_SUCCESS', 3);

define('BIZFORUM_FRAME_VIEW_NONE','none');
define('BIZFORUM_FRAME_VIEW_SUCCESS','success');
define('BIZFORUM_FRAME_VIEW_ERROR','error');
define('BIZFORUM_FRAME_VIEW_INDEX','index');
define('BIZFORUM_FRAME_VIEW_INPUT','input');
define('BIZFORUM_FRAME_VIEW_PREVIEW','preview');
define('BIZFORUM_FRAME_VIEW_CANCEL','cancel');

/**
 * Bizforum_Module
**/
class Bizforum_Module extends Legacy_ModuleAdapter
{
    /**
     * @brief   string
    **/
    ...
    **/
    protected $_mAllowViewNames = array(
        BIZFORUM_FRAME_VIEW_NONE,
        BIZFORUM_FRAME_VIEW_SUCCESS,
        BIZFORUM_FRAME_VIEW_ERROR,
        BIZFORUM_FRAME_VIEW_INDEX,
        BIZFORUM_FRAME_VIEW_INPUT,
        BIZFORUM_FRAME_VIEW_PREVIEW,
        BIZFORUM_FRAME_VIEW_CANCEL
    );
    ...
    **/
    public function startup()
    {
        ...
        XCube_DelegateUtils::call('Module.bizforum.Global.Event.GetAssetManager',new XCube_Ref($this->mAssetManager),$this->mXoopsModule->get('dirname'));
    ...
    **/
    public function getRenderSystemName()
    {
        ...
        if(!defined('BIZFORUM_ADMIN_RENDER_REGISTED'))
        {
            define('BIZFORUM_ADMIN_RENDER_REGISTED',true);
            $root =& XCube_Root::getSingleton();
            $root->overrideSiteConfig(
                array(
                    'RenderSystems' => array(
                        'Bizforum_AdminRenderSystem' => 'Bizforum_AdminRenderSystem'
                    ),
                    'Bizforum_AdminRenderSystem' => array(
                        'root' => BIZFORUM_TRUST_PATH,
                        'path' => '/admin/class/BizforumAdminRenderSystem.class.php',
                        'class' => 'Bizforum_AdminRenderSystem'
                    )
                )
            );
        }
    
        return 'Bizforum_AdminRenderSystem';
    }
    ...
    **/
    public function execute(/*** XCube_Controller ***/ &$controller)
    {
        ...
        $viewStatus = (Bizforum_Utils::getEnv('REQUEST_METHOD') == 'POST') ?
    ...
    private function _createAction()
    {
        ...
        switch(true)
        {
            case file_exists(
                ...
                break;
            case file_exists(
                $path = BIZFORUM_TRUST_PATH . '/' . $fileName
            ):
                break;
            default:
                return false;
        ...
        $className = 'Bizforum_' . ($this->mAdminFlag ? 'Admin_' : '')
            . ucfirst($this->mActionName) . 'Action';
        if(class_exists($className))
        {
            $this->mAction =& new $className();
        }
        if(!$this->mAction instanceof Bizforum_AbstractAction)
        {
            return false;
        }
    ...
    **/
    ...
    {
        /**
         * Module.bizforum.Global.Event.Exception.ActionNotFound
         * 
         * @param   string  $dirname
         * 
         * @return  void
        **/
        XCube_DelegateUtils::call('Module.bizforum.Global.Event.Exception.ActionNotFound',$this->mAssetManager->mDirname);
        /**
    ...
    **/
    ...
    {
        /**
         * Module.bizforum.Global.Event.Exception.Preparation
         * 
         * @param   string  $dirname
         * 
         * @return  void
        **/
        XCube_DelegateUtils::call('Module.bizforum.Global.Event.Exception.Preparation',$this->mAssetManager->mDirname);
        /**
    ...
    **/
    ...
    {
        /**
         * Module.bizforum.Global.Event.Exception.Permission
         * 
         * @param   string  $dirname
         * 
         * @return  void
        **/
        XCube_DelegateUtils::call('Module.bizforum.Global.Event.Exception.Permission',$this->mAssetManager->mDirname);
        /**
