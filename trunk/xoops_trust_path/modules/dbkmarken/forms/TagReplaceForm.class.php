...
class Dbkmarken_TagReplaceForm extends XCube_ActionForm
{
	/**
	 * @public
	 */
	...
	{
		return "module.dbkmarken.TagReplaceForm.TOKEN";
	}
	...
	function prepare()
	{
		...
		$this->mFieldProperties['tag_name']->addMessage('required', _MD_DBKMARKEN_ERROR_REQUIRED, _MD_DBKMARKEN_LANG_TAG_NAME);
