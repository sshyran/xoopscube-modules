...
/**
 * Dbkmarken_AssetManager
**/
class Dbkmarken_AssetManager
{
    /**
     * @brief   string
    **/
     ...
     * @brief   string
    **/
    public $mTrustDirname = 'dbkmarken';
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Dbkmarken_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Dbkmarken_AssetManager[]
        **/
        static $instance = array();
    
        if(!isset($instance[$dirname]))
        {
            $instance[$dirname] = new Dbkmarken_AssetManager($dirname);
        }
    ...
    **/
    ...
    {
        return DBKMARKEN_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}
