<?php
/**
 * @version $Id: modinfo.php 435 2008-05-09 11:03:41Z hodaka $
...
define ( $constpref.'_WYSIWYG_DSC','FCKeditor is allowed only to HTML allowed users. (Image uploading only by admins.)' );
...
define ( $constpref.'_COM_AGENT','Select comment system' );
