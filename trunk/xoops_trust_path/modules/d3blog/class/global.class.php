<?php
/**
 * @version $Id: global.class.php 620 2009-08-29 01:21:28Z hodaka $
...
class '. $mydirname .'
{
    ...
    function '. $mydirname .'() {
        ...
        $preferences = dirname(dirname(__FILE__))."/include/preferences.inc.php";
        if(file_exists($preferences))
            require $preferences;
        else
            require dirname(dirname(__FILE__))."/include/preferences.default.php";
