...
if( $photo_small_sum > 0 ) {
	...
	$prs = $xoopsDB->query( "SELECT l.lid, l.cid,l.cid1,l.cid2,l.cid3,l.cid4, l.title, l.poster_name,l.icd, l.ext, l.res_x, l.res_y, l.ext1, l.res_x1, l.res_y1,l.ext2, l.res_x2, l.res_y2, l.status, l.date, l.hits, l.rating, l.votes, l.comments,l.caption,l.caption1,l.caption2, l.submitter,l.url,l.tel,l.fax,l.zip,l.address,l.lat,l.lng,l.zoom,l.mtype,  t.description,t.arrowhtml,t.addinfo FROM $table_photos l USE INDEX (date) INNER JOIN $table_text t ON l.lid=t.lid WHERE $where AND l.status>0 ORDER BY {$gnavi_orders[$orderby][0]}" , $num , $pos ) ;
	if( ! $prs ) {
		$prs = $xoopsDB->query( "SELECT l.lid, l.cid,l.cid1,l.cid2,l.cid3,l.cid4, l.title, l.poster_name,l.icd, l.ext, l.res_x, l.res_y, l.ext1, l.res_x1, l.res_y1,l.ext2, l.res_x2, l.res_y2, l.status, l.date, l.hits, l.rating, l.votes, l.comments,l.caption,l.caption1,l.caption2, l.submitter,l.url,l.tel,l.fax,l.zip,l.address,l.lat,l.lng,l.zoom,l.mtype,  t.description,t.arrowhtml,t.addinfo FROM $table_photos l INNER JOIN $table_text t ON l.lid=t.lid WHERE $where AND l.status>0 ORDER BY {$gnavi_orders[$orderby][0]}" , $num , $pos ) ;
	}
