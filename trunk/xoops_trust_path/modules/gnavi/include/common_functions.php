...
function gnavi_update_item($mode,$lid,
                            ...
                            $url,$tel,$fax,$zip,$address,$lat,$lng,$zoom,$mtype,$icd,
	...
	if( $mode == G_INSERT){
		...
		$sql .= "url,tel,fax,zip,address,lat,lng,zoom,mtype,icd,";
		$sql .= "submitter,poster_name,status,date) VALUES (";
		$sql .= "$lid,'".addSlashes($title)."',$cid,$cid1,$cid2,$cid3,$cid4,";
		$sql .= "'".addSlashes($url)."','".addSlashes($tel)."','".addSlashes($fax)."','".addSlashes($zip)."','".addSlashes($address)."',$lat,$lng,$zoom,'".addSlashes($mtype)."',$icd,";
        ...
        $sql .= "url='".addSlashes($url)."',tel='".addSlashes($tel)."',fax='".addSlashes($fax)."',zip='".addSlashes($zip)."',address='".addSlashes($address)."',lat=$lat,lng=$lng,zoom=$zoom,mtype='".addSlashes($mtype)."',icd=$icd,";
