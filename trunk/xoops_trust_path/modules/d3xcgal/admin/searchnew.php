...
function display_dir_tree($folder, $ident)
{
        ...
        while($file = readdir($dir)){
                if(is_dir(XOOPS_ROOT_PATH.'/modules/'.$mydirname.'/'.$xoopsModuleConfig['fullpath'].$folder.$file) && $file != "." && $file != "..") {
                        ...
                        <tr>
                                <td class="even">
                                        $ident<img src="../images/folder.gif" alt="">&nbsp;<a href= "index.php?page=searchnew&startdir=$start_target">$file</a>$warnings
                                </td>
                        </tr>
EOT;
...
if (isset($_POST['insert'])){
    ...
    echo "<td class='head' valign='middle' align='center'><b>"._AM_D3XCGAL_SRCHNEW_RESULT."</b></td>";
        ...
        foreach ($_POST['pics'] as $pic_id){
                ...
                $status = "<a href=\"../index.php?page=addpic&aid=$album_id&pic_file=".($_POST['picfile_'.$pic_id])."&reload=".uniqid('')."\"><img src=\"../addpic.php?aid=$album_id&pic_file=".($_POST['picfile_'.$pic_id])."&reload=".uniqid('')."\" class=\"thumbnail\" border=\"0\" width=\"24\" height=\"24\" /><br /></a>";
        ...
        echo "<form method=\"post\" action=\"index.php?page=searchnew&insert=1\">";
