...
eval( ' function xoops_module_update_'.$mydirname.'( $module ) { return d3xcgal_onupdate_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'd3xcgal_onupdate_base' ) ) {

function d3xcgal_onupdate_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleUpdate.' . ucfirst($mydirname) . '.Success', 'd3xcgal_message_append_onupdate' ) ;
		$msgs = array() ;
	} else {
...
function d3xcgal_message_append_onupdate( &$module_obj , &$log )
{
