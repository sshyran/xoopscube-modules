...
if ($com_itemid > 0) {
    $sql="SELECT a.comments FROM ".$xoopsDB->prefix($mydirname."_albums")." as a, ".$xoopsDB->prefix($mydirname."_pictures")." as p WHERE a.aid=p.aid AND p.pid=".$com_itemid."";
...
if (USER_CAN_POST_COMMENTS && $CURRENT_ALBUM_DATA['comments'] == 'YES'){
    if ($com_itemid > 0) {
           // Get link title
           $sql = "SELECT title FROM " . $xoopsDB->prefix($mydirname."_pictures") . " WHERE pid=" . $com_itemid . "";
       $result = $xoopsDB->query($sql);
