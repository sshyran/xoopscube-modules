...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return d3xcgal_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'd3xcgal_oninstall_base' ) ) {

function d3xcgal_oninstall_base( $module , $mydirname )
{
	...
	if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
		...
		$root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'd3xcgal_message_append_oninstall' ) ;
		$ret = array() ;
	} else {
...
function d3xcgal_message_append_oninstall( &$module_obj , &$log )
{
