...
define('_MD_D3DIARY_HELP_IMPORTFROM','現在インポートに対応しているのは d3diary 、minidiary 、d3blogです。d3blogはtrackbackテーブルのインポートも行いますがtrackback機能はありません。　また、カテゴリは予め２階層までにまとめておく必要があります。');
