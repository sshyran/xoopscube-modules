...
define('_MD_D3DIARY_HELP_IMPORTFROM','You can import only from d3diary, minidiary or d3blog. For d3blog, trackback table will be also imported but no function in d3diary, and category should be compressed upto 2 layers before execution of importing.');
