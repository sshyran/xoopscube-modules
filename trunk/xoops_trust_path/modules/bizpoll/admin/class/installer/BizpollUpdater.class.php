...
require_once BIZPOLL_TRUST_PATH . '/admin/class/installer/BizpollInstallUtils.class.php';

/**
 * Bizpoll_Updater
**/
class Bizpoll_Updater
{
    /**
    ...
    **/
    ...
    {
        Bizpoll_InstallUtils::uninstallAllOfModuleTemplates($this->_mTargetXoopsModule,$this->mLog);
        Bizpoll_InstallUtils::installAllOfModuleTemplates($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        Bizpoll_InstallUtils::smartUpdateAllOfBlocks($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        Bizpoll_InstallUtils::smartUpdateAllOfConfigs($this->_mTargetXoopsModule,$this->mLog);
    }
    ...
    **/
    ...
    {
        $this->mLog->addReport(_MI_BIZPOLL_INSTALL_MSG_UPDATE_STARTED);
    ...
    **/
    public function saveXoopsModule(/*** XoopsModule ***/ &$module)
    {
        ...
        {
            $this->mLog->addReport(_MI_BIZPOLL_INSTALL_MSG_UPDATE_FINISHED);
        }
        else
        {
            $this->mLog->addError(_MI_BIZPOLL_INSTALL_ERROR_UPDATE_FINISHED);
        }
    }
    ...
    **/
    private function _processReport()
    {
        if(!$this->mLog->hasError())
        {
            $this->mLog->add(
                XCube_Utils::formatString(
                    _MI_BIZPOLL_INSTALL_MSG_MODULE_UPDATED,
        ...
        else
        {
            $this->mLog->add(
                XCube_Utils::formatString(
                    _MI_BIZPOLL_INSTALL_ERROR_MODULE_UPDATED,
                    $this->_mCurrentXoopsModule->get('name')
                )
            );
        }
