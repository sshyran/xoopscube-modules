...
/**
 * Bizpoll_AssetManager
**/
class Bizpoll_AssetManager
{
    /**
     * @brief   string
    **/
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Bizpoll_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Bizpoll_AssetManager[]
        **/
        static $instance = array();
    
        if(!isset($instance[$dirname]))
        {
            $instance[$dirname] = new Bizpoll_AssetManager($dirname);
        }
    ...
    **/
    ...
    {
        return BIZPOLL_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}
