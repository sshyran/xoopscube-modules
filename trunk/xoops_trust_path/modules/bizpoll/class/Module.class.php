...
require_once BIZPOLL_TRUST_PATH . '/class/AbstractAction.class.php';

define('BIZPOLL_FRAME_PERFORM_SUCCESS', 1);
define('BIZPOLL_FRAME_PERFORM_FAIL', 2);
define('BIZPOLL_FRAME_INIT_SUCCESS', 3);

define('BIZPOLL_FRAME_VIEW_NONE','none');
define('BIZPOLL_FRAME_VIEW_SUCCESS','success');
define('BIZPOLL_FRAME_VIEW_ERROR','error');
define('BIZPOLL_FRAME_VIEW_INDEX','index');
define('BIZPOLL_FRAME_VIEW_INPUT','input');
define('BIZPOLL_FRAME_VIEW_PREVIEW','preview');
define('BIZPOLL_FRAME_VIEW_CANCEL','cancel');

/**
 * Bizpoll_Module
**/
class Bizpoll_Module extends Legacy_ModuleAdapter
{
    /**
     * @brief   string
    **/
    ...
    **/
    protected $_mAllowViewNames = array(
        BIZPOLL_FRAME_VIEW_NONE,
        BIZPOLL_FRAME_VIEW_SUCCESS,
        BIZPOLL_FRAME_VIEW_ERROR,
        BIZPOLL_FRAME_VIEW_INDEX,
        BIZPOLL_FRAME_VIEW_INPUT,
        BIZPOLL_FRAME_VIEW_PREVIEW,
        BIZPOLL_FRAME_VIEW_CANCEL
    );
    ...
    **/
    public function startup()
    {
        ...
        XCube_DelegateUtils::call('Module.bizpoll.Global.Event.GetAssetManager',new XCube_Ref($this->mAssetManager),$this->mXoopsModule->get('dirname'));
    ...
    **/
    public function getRenderSystemName()
    {
        ...
        if(!defined('BIZPOLL_ADMIN_RENDER_REGISTED'))
        {
            define('BIZPOLL_ADMIN_RENDER_REGISTED',true);
            $root =& XCube_Root::getSingleton();
            $root->overrideSiteConfig(
                array(
                    'RenderSystems' => array(
                        'Bizpoll_AdminRenderSystem' => 'Bizpoll_AdminRenderSystem'
                    ),
                    'Bizpoll_AdminRenderSystem' => array(
                        'root' => BIZPOLL_TRUST_PATH,
                        'path' => '/admin/class/BizpollAdminRenderSystem.class.php',
                        'class' => 'Bizpoll_AdminRenderSystem'
                    )
                )
            );
        }
    
        return 'Bizpoll_AdminRenderSystem';
    }
    ...
    **/
    public function execute(/*** XCube_Controller ***/ &$controller)
    {
        ...
        $viewStatus = (Bizpoll_Utils::getEnv('REQUEST_METHOD') == 'POST') ?
    ...
    private function _createAction()
    {
        ...
        switch(true)
        {
            case file_exists(
                ...
                break;
            case file_exists(
                $path = BIZPOLL_TRUST_PATH . '/' . $fileName
            ):
                break;
            default:
                return false;
        ...
        $className = 'Bizpoll_' . ($this->mAdminFlag ? 'Admin_' : '')
    ...
    **/
    ...
    {
        /**
         * Module.bizpoll.Global.Event.Exception.ActionNotFound
         * 
         * @param   string  $dirname
         * 
         * @return  void
        **/
        XCube_DelegateUtils::call('Module.bizpoll.Global.Event.Exception.ActionNotFound',$this->mAssetManager->mDirname);
        /**
    ...
    **/
    ...
    {
        /**
         * Module.bizpoll.Global.Event.Exception.Preparation
         * 
         * @param   string  $dirname
         * 
         * @return  void
        **/
        XCube_DelegateUtils::call('Module.bizpoll.Global.Event.Exception.Preparation',$this->mAssetManager->mDirname);
        /**
    ...
    **/
    ...
    {
        /**
         * Module.bizpoll.Global.Event.Exception.Permission
         * 
         * @param   string  $dirname
         * 
         * @return  void
        **/
        XCube_DelegateUtils::call('Module.bizpoll.Global.Event.Exception.Permission',$this->mAssetManager->mDirname);
        /**
