...
define('_MD_DBCSS_LABEL_INPORT','The CSS file that does the import is selected.');
define('_MD_DBCSS_LABEL_CSS_DIR','Directory at up-loading destination');
define('_MD_DBCSS_CSS_NODIR','The directory is not found at the up-loading destination.');
define('_MD_DBCSS_CSS_NOWRITABLE','Please write and set Zoc to the directory at the up-loading destination. ');
define('_MD_DBCSS_CSS_DIR_NONE','The directory was not found at the up-loading destination. ');
define('_MD_DBCSS_INPORTDESC','The import can be easily done by making the CSS file DB template. <br />The up-loaded CSS file is preserved in the default template set.<br>Moreover, it is also possible to select an arbitrary template set in addition to default and to do the import.<br />Please use it for the directory after writing and permitting at the up-loading destination. ');
define('_MD_DBCSS_CSS_DIR_NOWRITABLE','Please confirm the permission of the directory at the up-loading destination.');
define('_MD_DBCSS_INSERTTEMPLATEERROR','The error occurred, and it was not possible to preserve it in DB. File name: %s');
define('_MD_DBCSS_INPORTED','import was completed.');
define('_MD_DBCSS_UPLOADERROR','It failed in up-loading. Extension');
define('_MD_DBCSS_UPLOADEXITERROR','it is not possible to up-load it.');
define('_MD_DBCSS_UPLOADE_ERROR','It failed in up-loading.');
...
define('_MD_DBCSS_LABEL_SELECTTPLSETS','Template set selection');
...
define('_MD_DBCSS_EXPORT_ERROR','It failed in the export.');
define('_MD_DBCSS_EXPORT_CHECK_NONE','Please specify the exporting template.');
define('_MD_DBCSS_EXPORT_DIR_NONE','The directory was not found the export ahead.');
define('_MD_DBCSS_EXPORT_DIR_NONEWRITABLE','Please write and set Zoc to the directory the export ahead.');
define('_MD_DBCSS_EXPORT_DIR','Directory export default ahead');
define('_MD_DBCSS_EXPORTDESC','The CSS template preserved in DB can be exported as CSS file. <br />Please use it after specifying the directory by "General setting" the export ahead, and 
writing and permitting.<br /> When the directory is preserved the export each template ahead, it fills in by the form similar to a general setting, and it transmits.');
define('_MD_DBCSS_EXPORT_NODIR','The directory is not found the export ahead.');
define('_MD_DBCSS_EXPORT_NOWRITABLE','Please write and set Zoc to the directory the export ahead.');
define('_MD_DBCSS_MYEXPORT_DIR','Directory export ahead');
define('_MD_DBCSS_LABEL_EXPORT_DIR','The directory the export each template ahead is preserved.');
define('_MD_DBCSS_BTN_COPYTPL','Copy execution');
define('_MD_DBCSS_LABEL_COPYTPLSETS','At the copy destination');
define('_MD_DBCSS_COPY_CHECK_NONE','Please specify the template set at the template and copy destinations of the copy.');
define('_MD_DBCSS_COPYED','The copy was completed.');
define('_MD_DBCSS_COPYTEMPLATEERROR','It failed in the copy. ID: %s');
define('_MD_DBCSS_COPYABORT','The copy origin and copy destinations interrupted because of the same.');
...
define('_MD_DBCSS_LABEL_DOWNLOADTPLSETS','Download at each template set');
define('_MD_DBCSS_DOWNLOADERROR','Please select the downloaded template set.');
define('_MD_DBCSS_MYTPLSFORM_EDIT','Template edit');
define('_MD_DBCSS_MYTPLSFORM_BTN_MODIFYCONT','It updates and it continues the edit.');
define('_MD_DBCSS_MYTPLSFORM_BTN_MODIFYEND','It updates and it ends the edit.');
define('_MD_DBCSS_MYTPLSFORM_BTN_RESET','Reset');
define('_MD_DBCSS_MYTPLSFORM_UPDATED','The template was renewed.');
...
define('_MD_DBCSS_BTN_SUBMITEDITING','Preservation');
define('_MD_DBCSS_BTN_CANSEL','Cancel');
define('_MD_DBCSS_MSG_CONFIRMDELETECONTENT','May I delete the content of registration?');
define('_MD_DBCSS_NO_DATA','There is no preserved data.');
define('_MD_DBCSS_MODULE_NOTFOUND','The module is not found.');
define('_MD_DBCSS_REGSTERED','It preserved it. ');
define('_MD_DBCSS_DELETED','It deleted it. ');
...
define('_MD_DBCSS_BTN_COPY','It preserves it as another data. ');
...
define('_MD_DBCSS_MSG_CONFIRMCOPYCONTENT','May I preserve the content of registration as another data?');
