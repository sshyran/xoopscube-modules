...
deregisterDraggable: function(aDraggable) {
      this._delMouseDownHandler( aDraggable );
      var newDraggables = new Array();
      var j = 0;
      for ( var i = 0 ; i < this.draggables.length ; i++ ) {
         if ( this.draggables[i] != aDraggable )
            newDraggables[j++] = this.draggables[i];
      }
  ...
  _delMouseDownHandler: function( aDraggable )
   {
       htmlElement  = aDraggable.getMouseDownHTMLElement();
      if ( htmlElement  != null ) { 
         htmlElement.draggable = aDraggable;
