 ...
 *
 * @package Legacy
 * @version $Id: install_updateConfig_go.inc.php,v 1.2 2007/06/24 07:26:22 nobunobu Exp $
 ...
 */
    ...
    $xoopsConfig['usercookie'] = "xoopserver_user";
    $xoopsConfig['sessioncookie'] = "xoopserver_session";
    ...
    $xoopsConfig['avatar_width'] = 80;
    $xoopsConfig['avatar_height'] = 80;
    ...
    $dbm->insert('config', " VALUES (16, 0, 1, 'session_name', '_MD_AM_SESSNAME', 'xoopserver_session', '_MD_AM_SESSNAMEDSC', 'textbox', 'text', 20)");
    ...
    $dbm->insert('config', " VALUES (42, 0, 4, 'censor_replace', '_MD_AM_CENSORRPLC', '#CENSORED#', '_MD_AM_CENSORRPLCDSC', 'textbox', 'text', 2)");
    $dbm->insert('config', " VALUES (44, 0, 5, 'enable_search', '_MD_AM_DOSEARCH', '1', '_MD_AM_DOSEARCHDSC', 'yesno', 'int', 0)");
    $dbm->insert('config', " VALUES (45, 0, 5, 'keyword_min', '_MD_AM_MINSEARCH', '4', '_MD_AM_MINSEARCHDSC', 'textbox', 'int', 1)");
    ...
    $dbm->insert('config', " VALUES (61, 0, 1, 'sslpost_name', '_MD_AM_SSLPOST', 'xoopserver_ssl', '_MD_AM_SSLPOSTDSC', 'textbox', 'text', 31)");
    ...
    $time = time();
    $dbm->insert('tplset', " VALUES (1, 'default', 'XOOPSERVER Default Theme', '', ".$time.")");
