...
This module has a status of beta.
...
- modifying operations/developments of any versions of core (X2,XC2.1,X2.2 etc.) efficient
...
- X2, XC2.1, X2.2等、あらゆるコアの操作性・開発効率を向上します
