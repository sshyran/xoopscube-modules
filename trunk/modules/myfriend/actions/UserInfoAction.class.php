...
class Myfriend_UserInfoAction
{
  ...
  private $mRankObject = null;
  private $mSearchResults = null;
  private $mSelfDelete = false;
  private $mPmliteURL = null;
  ...
  private function _seterrMsg($msg)
  {
    $this->errFlg = true;
    $this->errMsg[] = $msg;
  }
  ...
  private function get_myfreindlist()
  {
    $freiends = false;
    $root = XCube_Root::getSingleton();
