...
define('CUBE_UTILS_ML_LANGS','en,jp'); // [en]english[/en]  [ja]japanese[/ja] common

// list the language images separated with comma
define('CUBE_UTILS_ML_LANGIMAGES','modules/cubeUtils/images/english.gif,modules/cubeUtils/images/japanese.gif');

// list the language names separated with comma
define('CUBE_UTILS_ML_LANGNAMES','english,japanese');
