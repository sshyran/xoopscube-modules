...
//	Index (Menu)
define ("_AM_MYXBACKUP_NOTICEONINDEX",	"Don't click twice or more.");
...
define ("_AM_MYXBACKUP_OPTIMIZE_DESC",	"Optimize XOOPS database tables.");
define ("_AM_MYXBACKUP_CHECK_TITLE",	"CHECK");
define ("_AM_MYXBACKUP_CHECK_DESC",	"Check XOOPS database tables.");
define ("_AM_MYXBACKUP_CLEANUP_TITLE",	"Clean Up");
define ("_AM_MYXBACKUP_CLEANUP_DESC",	"Delete unneccesary tables.");
define ("_AM_MYXBACKUP_BACKUP_TITLE",	"BACK UP");
define ("_AM_MYXBACKUP_BACKUP_DESC",	"Back up XOOPS databse tables.<br />Download SQL files zipped by each modules.");
define ("_AM_MYXBACKUP_BACKUPMOD_TITLE","BACK UP (by Module)");
define ("_AM_MYXBACKUP_BACKUPMOD_DESC",	"Back up XOOPS databse tables by each module.");
define ("_AM_MYXBACKUP_DUMP_TITLE",	"Dump");
define ("_AM_MYXBACKUP_DUMP_DESC",	"Dump XOOPS database tables (SQL text format)");
define ("_AM_MYXBACKUP_EXPORT_TITLE",	"Export");
define ("_AM_MYXBACKUP_EXPORT_DESC",	"Export XOOPS database table (CSV format)");
define ("_AM_MYXBACKUP_RESTORE_TITLE",	"RESTORE");
define ("_AM_MYXBACKUP_RESTORE_DESC",	"Restore backuped database tables.<br />Must put SQL files into 'sql' directory.");
