...
class Cubookmarken_BmEditForm extends XCube_ActionForm
{
	/**
	 * @public
	 */
	...
	{
		return "module.cubookmarken.BmEditForm.TOKEN";
	}
	...
	function prepare()
	{
		...
		$this->mFieldProperties['bm_title']->addMessage('required', _MD_CUBOOKMARKEN_ERROR_REQUIRED, _MD_CUBOOKMARKEN_LANG_BM_TITLE, '255');
		$this->mFieldProperties['bm_title']->addMessage('maxlength', _MD_CUBOOKMARKEN_ERROR_MAXLENGTH, _MD_CUBOOKMARKEN_LANG_BM_TITLE, '255');
		...
		$this->mFieldProperties['url']->addMessage('required', _MD_CUBOOKMARKEN_ERROR_REQUIRED, _MD_CUBOOKMARKEN_LANG_URL, '255');
		$this->mFieldProperties['url']->addMessage('maxlength', _MD_CUBOOKMARKEN_ERROR_MAXLENGTH, _MD_CUBOOKMARKEN_LANG_URL, '255');
		$this->mFieldProperties['url']->addVar('maxlength', '255');
		$this->mFieldProperties['url']->addMessage('mask', _MD_CUBOOKMARKEN_ERROR_URLMASK, 'http://');
		...
		$this->mFieldProperties['uid']->addMessage('required', _MD_CUBOOKMARKEN_ERROR_REQUIRED, _MD_CUBOOKMARKEN_LANG_UID);
	
		$this->mFieldProperties['memo'] =& new XCube_FieldProperty($this);
		$this->mFieldProperties['memo']->setDependsByArray(array());
	
		$this->mFieldProperties['reg_unixtime'] =& new XCube_FieldProperty($this);
		$this->mFieldProperties['reg_unixtime']->setDependsByArray(array());
	}
