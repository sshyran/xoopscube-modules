...
class Cubookmarken_TagEditForm extends XCube_ActionForm
{
	/**
	 * @public
	 */
	...
	{
		return "module.cubookmarken.TagEditForm.TOKEN";
	}
	...
	function prepare()
	{
		...
		$this->mFieldProperties['reg_unixtime']->addMessage('required', _MD_CUBOOKMARKEN_ERROR_REQUIRED, _MD_CUBOOKMARKEN_LANG_REG_UNIXTIME);
	}
