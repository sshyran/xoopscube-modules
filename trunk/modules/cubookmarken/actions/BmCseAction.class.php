...
class Cubookmarken_BmCseAction extends Cubookmarken_AbstractListAction
{
	...
	{
		$render->setTemplateName("cubookmarken_bm_cse.xml");
		...
		$tpl->display("db:cubookmarken_bm_cse.xml");
	}
