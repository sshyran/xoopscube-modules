...
//	$tpl->xoops_setCacheTime(3600);
	if (!$tpl->is_cached("db:cubookmarken_rss.html")) {
		$tpl->assign('channel_title', xoops_utf8_encode($title));
		$tpl->assign('channel_link', XOOPS_URL.'/modules/cubookmarken/');
		$tpl->assign('channel_desc', "Cubookmarken");
		$tpl->assign('channel_lastbuild', formatTimestamp(time(), 'rss'));
		$tpl->assign('channel_webmaster', '');
		$tpl->assign('channel_editor', '');
		$tpl->assign('channel_category', 'bookmark');
		$tpl->assign('channel_generator', 'XOOPS/Cubookmarken');
