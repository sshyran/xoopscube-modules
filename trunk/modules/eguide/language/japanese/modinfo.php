<?php
// $Id: modinfo.php,v 1.18 2008-02-03 15:28:52 nobu Exp $
// Module Info
...
define("_MI_EGUIDE_LAB_PERSONS","人数指定の追加項目");
define("_MI_EGUIDE_LAB_PERSONS_DESC","予約人数を指定を許可する場合の項目の名前を指定する");
...
define("_MI_EGUIDE_PLUGINS","他のモジュールと内部連係する");
define("_MI_EGUIDE_PLUGINS_DESC","イベントの申込制御に、他のモジュールからの介入を行うプラグインを有効にする");
...
define("_MI_EGUIDE_ADDON_OPTS","追加処理用のオプション");
define("_MI_EGUIDE_ADDON_OPTS_DESC","追加処理対するオプショナル引数を指定する。オプションは <tt>名前: 値</tt> の行形式で指定し、その内容は対応する処理に依存する。");
// Templates
...
define('_MI_EGUIDE_NEWPOST_SUBJECT', '新規イベント - {EVENT_TITLE}');
