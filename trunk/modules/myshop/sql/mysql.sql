...
CREATE TABLE `myshop_products` (
  ...
  `product_hits` int(11) unsigned NOT NULL default '0' COMMENT 'How many views of the product page',
  ...
  `product_download_url` varchar(255) NOT NULL COMMENT 'URL to download the product',
