...
if (isset($_POST['imgdir']) && preg_match('/^[a-zA-Z0-9_\-]+$/', $_POST['imgdir'])) {
	...
	$imgdirchk = true;
	for ($i=0; $i<=9; $i++) {
		if (!file_exists($imgdir.$newdir."/$i.gif")) { $imgdirchk = false; break; }
	}
	if ($imgdirchk) {
...
print '<div class="tips">Visit please <b><a href="http://www.digitmania.holowww.com/" target="_blank">Digit Mania</a></b> : A collection of digit styles for use with HTML counters.</div><br />';
