...
var wikihelper_root_url = 'http://localhost/xoopscube/modules/xpwiki';
...
function wikihelper_show_fontset_img()
{
	...
	str += ' <a href="#" title="Close" onClick="javascript:wikihelper_hide_helper(); return false;"><img src="http://localhost/xoopscube/modules/xpwiki/skin/loader.php?src=close.gif" border="0" alt="Close" '+'/'+'><'+'/'+'a>';
	...
	if (!wikihelper_mapLoad)
	{
		...
		src.href = 'http://localhost/xoopscube/modules/xpwiki/skin/loader.php?src=wikihelper.css';
		src.rel  = 'stylesheet';
		src.type = 'text/css';
