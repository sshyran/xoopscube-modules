...
echo "<div class='adminnavi' style='text-align:"._GLOBAL_LEFT.";'>"._MYTPLSADMIN_H3_MODULE." &raquo;&raquo; $target_mname</div>\n" ;
...
$fingerprint_styles = array( '' , 'background-color:#00CC00' , 'background-color:#0099CC' , 'background-color:#6666CC' , 'background-color:#CC3300' , 'background-color:#FF8800' , 'background-color:#0000FF' , 'background-color:#FFFFFF' ) ;
