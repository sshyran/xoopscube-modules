...
define( '_TPLSADMIN_DT_ENCLOSEBYCOMMENT' , 'Add comments' ) ;
define( '_TPLSADMIN_DD_ENCLOSEBYCOMMENT' , 'Two HTML comments will be implemented into the beginning/ending point of each template. Since this rarely breaks the design, it is recommended to professionals that read HTML' ) ;
define( '_TPLSADMIN_CNF_ENCLOSEBYCOMMENT' , 'Compiled template caches will be enclosed by tplsadmin comments. Do you want to confirm?' ) ;


define( '_TPLSADMIN_FMT_MSG_ENCLOSEBYBORDEREDDIV' , '%d template caches have been enclosed by div tags' ) ;
define( '_TPLSADMIN_DT_ENCLOSEBYBORDEREDDIV' , 'Add div tags' ) ;
define( '_TPLSADMIN_DD_ENCLOSEBYBORDEREDDIV' , 'Each template will be enclosed by black-bordered div tags. An edit link to controller of tplsadmin will be implemented into each template. Though this might often break templates design, it simplifies templates edition.' ) ;
define( '_TPLSADMIN_CNF_ENCLOSEBYBORDEREDDIV' , 'Compiled template caches will be enclosed by div tags. Do you want to confirm?' ) ;

define( '_TPLSADMIN_FMT_MSG_HOOKSAVEVARS' , '%d template caches have been implemented with hooks logics to collect template varibles' ) ;
define( '_TPLSADMIN_DT_HOOKSAVEVARS' , 'Implement logics to collect template variables' ) ;
...
define( '_TPLSADMIN_CNF_HOOKSAVEVARS' , 'Compiled template caches will be implemented the logics to collect template variables. Are you OK?' ) ;
...
define( '_TPLSADMIN_DD_REMOVEHOOKS' , 'This removes comments/div tags/logics implemented by upper operations from each compiled template caches.' ) ;
define( '_TPLSADMIN_CNF_REMOVEHOOKS' , 'Are you OK for normalizing?' ) ;
