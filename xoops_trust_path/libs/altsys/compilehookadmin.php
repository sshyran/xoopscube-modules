...
echo "
<div class='adminnavi'>"._MI_ALTSYS_MENU_COMPILEHOOKADMIN."</div>
...
echo "
	...
	<div class='confirm'>{$compile_hook['dd']}</div>
	<p align='center'><input type='submit' name='$command' id='$command' value='"._GO."' onclick='return confirm(\"{$compile_hook['conf_msg']}\");' style='width:120px;' /></p>
	<br />
	<hr />
\n";
}
...
echo "
<h4>"._TPLSADMIN_NUMCAP_COMPILEDCACHES.": $compiledcache_num <input type='submit' name='clearcache' value='"._DELETE."' onclick='return confirm(\""._TPLSADMIN_CNF_DELETEOK."\");' /></h4>

<h4>"._TPLSADMIN_NUMCAP_TPLSVARS.": $tplsvars_num <input type='submit' name='cleartplsvars' value='"._DELETE."' onclick='return confirm(\""._TPLSADMIN_CNF_DELETEOK."\");' /></h4>
...
<form action='?mode=admin&amp;lib=altsys&amp;page=get_tplsvarsinfo' method='post' target='_blank'>
	<h4>"._TPLSADMIN_DT_GETTPLSVARSINFO_DW."</h4>
	<div class='tips'>"._TPLSADMIN_DD_GETTPLSVARSINFO_DW."</div>
	
	<p align='center'><input type='submit' name='as_dw_extension_zip' value='zip' />
...
<hr />
	...
	<form action='?mode=admin&amp;lib=altsys&amp;page=get_templates' method='post' target='_blank'>
		<h4>"._TPLSADMIN_DT_GETTEMPLATES."</h4>
		<div class='tips'>"._TPLSADMIN_DD_GETTEMPLATES."</div>
		
		<p align='center'><select name='tplset'>$tplset_options</select>
...
<hr />
	...
	<form action='?mode=admin&amp;lib=altsys&amp;page=put_templates' method='post' enctype='multipart/form-data'>
		<h4>"._TPLSADMIN_DT_PUTTEMPLATES."</h4>
		<div class='tips'>"._TPLSADMIN_DD_PUTTEMPLATES."</div>
