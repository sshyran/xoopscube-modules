 ...
 * @version $Id: calendar.inc.php 281 2008-02-23 09:49:31Z hodaka $
 */

if (!defined('DATE_D3BLOG_CALC_CLASS')) {
    define('DATE_D3BLOG_CALC_CLASS', 1);
...
class MyCalendar {
    ...
    function MyCalendar($month='') {            // constructor to initiate date
