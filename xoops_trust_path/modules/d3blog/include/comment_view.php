<?php
// $Id: comment_view.php 252 2007-12-05 01:26:52Z hodaka $
//  ------------------------------------------------------------------------ //
...
//include_once XOOPS_ROOT_PATH.'/modules/system/constants.php'; // doesn't exists in Legacy
...
if (XOOPS_COMMENT_APPROVENONE != $xoopsModuleConfig['com_rule']) {
    ...
    if ($com_itemid > 0) {
        ...
        $navbar = '
<form id="d3blogComNavBar" method="get" action="'.$comment_config['pageName'].'">
  ...
  <tr>
    <td class="even" align="center"><select name="com_mode"><option value="flat"';
        ...
        if (!empty($xoopsModuleConfig['com_anonpost']) || is_object($xoopsUser)) {
            ...
            $xoopsTpl->assign('com_anonpost', true);    // for xcl2.1
        }
        $link_extra = '';
        if (isset($comment_config['extraParams']) && is_array($comment_config['extraParams'])) {
            foreach ($comment_config['extraParams'] as $extra_param) {
...
//        }
        ...
        $xoopsTpl->assign(array('commentsnav' => $navbar, 'editcomment_link' => 'index.php?page=comment_edit&amp;com_itemid='.$com_itemid.'&amp;com_order='.$com_order.'&amp;com_mode='.$com_mode.''.$link_extra, 'deletecomment_link' => 'index.php?page=comment_delete&amp;com_itemid='.$com_itemid.'&amp;com_order='.$com_order.'&amp;com_mode='.$com_mode.''.$link_extra, 'replycomment_link' => 'index.php?page=comment_reply&amp;com_itemid='.$com_itemid.'&amp;com_order='.$com_order.'&amp;com_mode='.$com_mode.''.$link_extra));
