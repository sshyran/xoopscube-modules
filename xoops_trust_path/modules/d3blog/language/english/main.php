...
define ( '_MD_D3BLOG_MESSAGE_TICKET_LIFETIME','Ticket will be expired in %d minutes.' );
...
define ( '_MD_D3BLOG_ERROR_NO_SUCH_USER','No such a user %d was found.' );
define ( '_MD_D3BLOG_ERROR_NO_SUCH_CATEGORY','No such a category %d was found.' );
...
define ( '_MD_D3BLOG_ERROR_COM_NAME_SIZEOVER', 'Name length exceeds %d bytes.' );
define ( '_MD_D3BLOG_ERROR_COM_EMAIL_REQUIRED', 'e-mail is required.' );
define ( '_MD_D3BLOG_ERROR_COM_EMAIL_SIZEOVER', 'e-mail length exceeds %d bytes.' );
define ( '_MD_D3BLOG_ERROR_COM_EMAIL_INVALID', 'Illega format of e-mail.' );
define ( '_MD_D3BLOG_ERROR_COM_URL_SIZEOVER', 'Url length exceeds %d bytes.' );
