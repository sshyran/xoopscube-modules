...
class D3pipesBlockWebphotolist extends D3pipesBlockAbstract {
	...
	function init()
	{
		...
		$this->block_options = array(
			...
			3 => empty( $params[3] ) ? 1 : intval( $params[3] ) , // cat_limit_recursive
	...
	function renderOptions( $index , $current_value = null )
	{
		...
		$ret_4 = _MD_D3PIPES_N4J_MAXENTRIES.'<input type="text" name="joint_options['.$index.'][4]" value="'.$options[4].'" size="2" style="text-align:right;" />' ;
